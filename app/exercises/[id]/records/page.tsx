...
export default function Records() {
  return (
    <div className="z-10 m-auto my-2 min-w-[330px] p-3">
      <div className="m-auto my-2 min-w-[330px] p-3">
        <p className="text-accent-600 text-[12px]">PERSONAL RECORDS</p>
      ...
      <div className="m-auto my-2 min-w-[330px] p-3">
        <p className="text-accent-600 text-[12px]">LIFETIME STATS</p>
